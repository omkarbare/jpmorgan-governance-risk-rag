...
import { askRag, type AskResponse } from "@/lib/api";
...
export default function HomePage() {
  ...
  async function submitQuestion(query: string) {
    ...
    try {
      const result = await askRag(query, groqApiKey.trim() || undefined);
      setResponse(result);
    } catch (requestError) {
      setError(
    ...
    <main className="site-shell">
      <aside className="sidebar">
        ...
        <p className="sidebar-note">
          Used only for this browser session. It is not intentionally stored
          by this interface.
        </p>
      ...
      <section className="content-area">
        ...
        <section className="assistant-panel">
          ...
          {error ? (
            <section className="error-card" role="alert">
              ...
              <h3>We could not complete this request.</h3>
              <p>{error}</p>
              <p className="error-note">
                Confirm that the backend is running and your session API key is
                valid.
              </p>
            </section>
          ) : null}
        ...
        <section className="scope-panel" id="documents">
          <p className="eyebrow">Scope and safeguards</p>

          <h2>
            Built for document-grounded governance and risk research.
          </h2>
          ...
          <div className="scope-grid">
            <div>
              <h3>Supported</h3>
              <p>
                Questions about indexed governance principles, Code of Conduct,
                and 10-K risk material.
              </p>
            </div>
            ...
            <div>
              <h3>Not supported</h3>
              <p>
                Personal investment, legal, employment, general-knowledge
                advice, confidential information, or unsafe requests.
              </p>
            </div>
            ...
            <div id="architecture">
              <h3>Architecture</h3>
              <p>
                FastAPI · Qdrant · dense and sparse retrieval · reciprocal-rank
                fusion · citation validation · guardrails.
              </p>
            </div>
          </div>
        </section>
